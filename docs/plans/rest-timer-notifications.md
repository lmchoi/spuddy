...
5. **Deep-link on notification tap** — `addNotificationResponseReceivedListener` routes tap to log-session screen. Test: listener calls correct router method with correct path.
